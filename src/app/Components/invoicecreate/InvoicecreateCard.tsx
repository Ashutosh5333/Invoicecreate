...
import { skincaredata, skincarehead, tratmenthead, treatmentdata } from "../../context";
  ...
  return (
    <div className="rounded-lg px-2   lg:shadow-xl  py-2  border-yellow-500 ">
        ...
        <table className="table-auto w-full">
          ...
          <tbody className="mt-5 text-left text-sm text-[#000000] w-[90%] m-auto">
            {skincaredata.map((item, index) => (
              <tr key={index} className="font-semibold text-[.5rem] mt-5 sm:text-[.7rem] px-8 py-4">
                <td className="text-left px-4 py-2">
                  <button className={`text-left bg-[#FFFFFF] text-black rounded py-2 px-8 lg:px-8 lg:py-2`}>
                    {item.title}
                  </button>
                </td>
                <td className="text-left px-4 py-2">
                ...
                <td className="text-left px-4 py-2">
                  <button className={`text-left  text-[#8B8B8B]
                `}>
      ...
      <div className="py-2 gap-5 flex justify-between">
        <div></div>
        <div className="flex gap-4">
          <button className={`text-center m-auto bg-black text-white rounded-2xl py-2 px-6 sm:px-10 lg:px-14 lg:py-2`}>
            Add
          </button>

          <button className={`text-center border-2 border-[#E11D48] m-auto text-[#E11D48] rounded-2xl py-2 px-4 sm:px-10 lg:px-12 lg:py-2`}>
            Remove
          </button>
        </div>
      </div>
